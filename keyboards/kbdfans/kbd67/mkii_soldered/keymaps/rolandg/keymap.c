...
// TODO: find a solution to enable whole AltGr layer of us-intl layout. currently only those work that are not on layer 1
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all( /* Base */
	...
	KC_LCTL, KC_LGUI, KC_LALT,          KC_SPC,           MO(1),            KC_SPC,           TT(1),   KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
  ),
  [1] = LAYOUT_all( /* FN */
	...
	_______,  US_ADIA,   US_SS, KC_MPLY, KC_MUTE, _______, _______, _______, _______, _______,  _______, _______,          _______,          _______,
	_______,  _______, _______, _______, _______, _______, KC_LEFT, KC_UP,   KC_DOWN, KC_RIGHT, _______, _______, KC_CAPS,          KC_PGUP, _______,
  ...
  /*   _______, KC_MPRV, KC_MNXT, KC_MPLY, KC_MUTE, _______, _______, _______, _______, _______, _______, _______,           _______,          _______, */
