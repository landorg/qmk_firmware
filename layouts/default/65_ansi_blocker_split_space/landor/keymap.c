...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_65_ansi_blocker_split_space(
      ...
      TT(2),    MT(MOD_RALT, KC_A), MT(MOD_LGUI, KC_S), MT(MOD_LSFT, KC_D), MT(MOD_LCTL, KC_F),  KC_G,    KC_H,    MT(MOD_RCTL, KC_J), MT(MOD_RSFT, KC_K), MT(MOD_LGUI, KC_L), MT(MOD_RALT, KC_SCLN), KC_QUOT,            KC_ENT,   KC_PGUP,
      KC_LSFT,  KC_Z,               KC_X,               KC_C,               KC_V,                KC_B,    KC_N,    KC_M,               KC_COMM,            KC_DOT,             KC_SLSH,                         KC_RSFT,  KC_UP,    KC_PGDN,
      KC_LCTL,  MO(2),              KC_LALT,            KC_BSPC,            KC_LGUI,             KC_SPC,                                                   MO(2),              RCTL_T(KC_RALT),                 KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
